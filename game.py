...
pygame.mixer.Channel(0).play(pygame.mixer.Sound('trueassets/audio/startline.mp3'), -1)
pygame.mixer.Channel(0).set_volume(0.5)

jump_fx = pygame.mixer.Sound('trueassets/audio/jump.wav')
jump_fx.set_volume(0.5)
shot_fx = pygame.mixer.Sound('trueassets/audio/shot.wav')
shot_fx.set_volume(0.5)
grenade_fx = pygame.mixer.Sound('trueassets/audio/grenade.wav')
...
ins_img = pygame.image.load('trueassets/instruction_btn.png').convert_alpha()
over_img = pygame.image.load('trueassets/game_over.png').convert_alpha()
game_img = pygame.image.load('trueassets/game_title.png').convert_alpha()
...
sky_img = pygame.image.load('trueassets/Background/1.png').convert_alpha()
#store tiles in a list

img_list = []
for x in range(TILE_TYPES):
    img = pygame.image.load(f'trueassets/tiles/{x}.png')
    img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
    img_list.append(img)

#load images
#bullet
bullet_img = pygame.image.load('trueassets/bullet/bullet.png').convert_alpha()
bullet_img2 = pygame.image.load('trueassets/bullet/bullet2.png').convert_alpha()

grenade_img = pygame.image.load('trueassets/grenade/grenade.png').convert_alpha()

health_box_img = pygame.image.load('trueassets/box/health_box.png').convert_alpha()
ammo_box_img = pygame.image.load('trueassets/box/ammo_box.png').convert_alpha()
grenade_box_img = pygame.image.load('trueassets/box/grenade_box.png').convert_alpha()
item_boxes = {
...
class Fishman(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_types:
            ...
            num_of_frames = len(os.listdir(f'trueassets/{self.char_type}/{animation}'))
            for i in range(num_of_frames):
                img = pygame.image.load(f'trueassets/{self.char_type}/{animation}/{i}.png')
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y, scale):
        ...
        for num in range(1, 6):
            img = pygame.image.load(f'trueassets/explosion/exp{num}.png').convert_alpha()
            img = pygame.transform.scale(img, (int(img.get_width() * scale), int(img.get_height() * scale)))
...
while run:
    ...
    if start_game == False:
        ...
        if start_button.draw(screen):
            ...
            pygame.mixer.Channel(1).play(pygame.mixer.Sound('trueassets/audio/bravesteel.mp3'), -1)
